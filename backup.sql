...
prompt Disabling triggers for AREAS...
alter table AREAS disable all triggers;
...
alter table LOCATIONS disable constraint SYS_C008844;
prompt Disabling foreign key constraints for ATTRACTIONS...
alter table ATTRACTIONS disable constraint SYS_C008851;
prompt Disabling foreign key constraints for ORDERS...
alter table ORDERS disable constraint SYS_C008869;
prompt Disabling foreign key constraints for TICKETS...
alter table TICKETS disable constraint SYS_C008859;
alter table TICKETS disable constraint SYS_C008860;
prompt Disabling foreign key constraints for ORDER_ITEMS...
alter table ORDER_ITEMS disable constraint SYS_C008872;
alter table ORDER_ITEMS disable constraint SYS_C008873;
prompt Deleting ORDER_ITEMS...
...
alter table LOCATIONS enable constraint SYS_C008844;
prompt Enabling foreign key constraints for ATTRACTIONS...
alter table ATTRACTIONS enable constraint SYS_C008851;
prompt Enabling foreign key constraints for ORDERS...
alter table ORDERS enable constraint SYS_C008869;
prompt Enabling foreign key constraints for TICKETS...
alter table TICKETS enable constraint SYS_C008859;
alter table TICKETS enable constraint SYS_C008860;
prompt Enabling foreign key constraints for ORDER_ITEMS...
alter table ORDER_ITEMS enable constraint SYS_C008872;
alter table ORDER_ITEMS enable constraint SYS_C008873;
prompt Enabling triggers for AREAS...
alter table AREAS enable all triggers;
